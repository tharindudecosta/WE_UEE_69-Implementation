...
import com.example.ayusri.Adapters.AppointmentAdapterDoctor
...
class DoctorAppointments : AppCompatActivity() {
    ...
    private fun getAppointments() {
        ...
        val query = dbRef.orderByChild("docId").equalTo(global.id)
        ...
        query.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    val mAdapter = AppointmentAdapterDoctor(docList)
